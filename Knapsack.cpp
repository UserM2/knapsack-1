            ...
            for (int k3 = 0;k3 < 4;k3++) {
                for (int k4 = 1;k4 <= 5;k4++) {
                    ...
                    if ((selection == 0) || (selection == 5)) {
                        fout.close();
                        std::string filenameWithArguments = "dyn_ortools.exe " + filename_string + " " + csv_path;
                    ...
                    if ((selection == 0) || (selection == 6)) {
                        fout.close();
                        std::string filenameWithArguments = "int_ortools.exe " + filename_string + " " + csv_path;
                        std::cout << "Filename: " << filenameWithArguments << "\n";
                        int retCode = system(filenameWithArguments.c_str());
                        fout.open(csv_path, std::ios::app);
                    }
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "Please select which algorithm you want to solve your problem\n";
    std::cout << "1.Greedy Approach csv\n";
    std::cout << "2.Brute Force csv\n";
    std::cout << "3.Branch and Bound csv\n";
    std::cout << "4.Dynamic csv \n";
    std::cout << "5.Dynamic by ortools csv\n";
    std::cout << "6.Integer by ortools csv\n";
    std::cout << "7.all algorithms\n";
    std::cout << "0.Exit\n";
